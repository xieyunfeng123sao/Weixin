package com.ityun.weixin.myapplication.util.addpic;
...
public class FunctionOptions implements Serializable {
     ...
     * serialVersionUID
     */
    private static final long serialVersionUID = -6893570301048430141L;
    ...
    private List<LocalMedia> selectMedia = new ArrayList<LocalMedia>();// 已选择的图片
    ...
    public static class Builder {
        ...
        public Builder setSelectMedia(List<LocalMedia> selectMedia) {
            if (options.getSelectMode() == FunctionConfig.MODE_SINGLE) {
                selectMedia = new ArrayList<LocalMedia>();
